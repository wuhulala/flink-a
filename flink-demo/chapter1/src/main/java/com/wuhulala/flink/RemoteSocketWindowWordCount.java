...
public class RemoteSocketWindowWordCount {
    ...
    public static void main(String[] args) throws Exception {
        ...
        final ExecutionEnvironment env = ExecutionEnvironment.createRemoteEnvironment("localhost", 8081, "D:\\01code\\personal\\flink\\flink-demo\\chapter1\\target\\chapter1-1.0-SNAPSHOT.jar");
